...
(function(w) {
    ...
    */
    var canvas_width = 1440; //Needs to be a multiple of the resolution value below.
    var canvas_height = 800; //This too.
    
    var resolution = 2; //Width and height of each cell in the grid.
    ...
    var speck_count = 750; //This determines how many particles will be made.
    ...
    */
    function draw() {
        ...
        */
        ...
        //This calls the function tlio update the particle positions.
        update_particle();
    ...
    */
    function update_velocity(cell_data) {
        ...
        */
        cell_data.xv += (
            cell_data.up_left.pressure * .5  
            + cell_data.left.pressure
            + cell_data.down_left.pressure * .5
            - cell_data.up_right.pressure * .5
            - cell_data.right.pressure
            - cell_data.down_right.pressure * .5
        ) * 0.25;
